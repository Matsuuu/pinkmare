" -----------------------------------------------------------------------------
" Name:         Pinkmare
" Description:  A crossup between Miramare and PinkCatBoo
" Author:       Matsuuu <huhta.matias@gmail.com>
" Website:      https://github.com/matsuuu/pinkmare
" License:      MIT
" -----------------------------------------------------------------------------
...
let s:configuration.enable_italic = get(g:, 'pinkmare_enable_italic', 0)
let s:configuration.enable_bold = get(g:, 'pinkmare_enable_bold', 1)
let s:configuration.cursor = get(g:, 'pinkmare_cursor', 'auto')
...
call s:HL('PmenuSel', s:palette.bg0, s:palette.yellow)
...
call s:HL('TabLine', s:palette.purple, s:palette.bg0)
call s:HL('TabLineFill', s:palette.grey, s:palette.bg0)
call s:HL('TabLineSel', s:palette.red, s:palette.bg0)
call s:HL('VertSplit', s:palette.bg4, s:palette.none)
call s:HL('Visual', s:palette.none, s:palette.bg1)
...
call s:HL('Structure', s:palette.red, s:palette.none)
...
if s:configuration.enable_italic_string
  call s:HL('String', s:palette.fg, s:palette.none, 'italic')
else
  call s:HL('String', s:palette.fg, s:palette.none)
endif
...
highlight! link jsObjectProp Purple
highlight! link jsObjectUse Green
highlight! link jsVariableDef Blue
highlight! link jsObjectKey Blue
...
highlight! link jsExportDefault Red
highlight! link jsVariableUse Green
highlight! link jsVariableFalse Red
...
highlight! link javascriptIdentifierName Green
...
highlight! link javascriptPropertyNameString Yellow
highlight! link javascriptFuncArg Orange
...
highlight! link javascriptMethod Yellow
highlight! link javascriptMethodName Yellow
highlight! link javascriptObjectMethodName Yellow
highlight! link javascriptGlobalMethod Yellow
highlight! link javascriptDOMStorageMethod Yellow
highlight! link javascriptFileMethod Yellow
highlight! link javascriptFileReaderMethod Yellow
highlight! link javascriptFileListMethod Yellow
highlight! link javascriptBlobMethod Yellow
highlight! link javascriptURLStaticMethod Yellow
highlight! link javascriptNumberStaticMethod Yellow
highlight! link javascriptNumberMethod Yellow
highlight! link javascriptDOMNodeMethod Yellow
highlight! link javascriptES6BigIntStaticMethod Yellow
highlight! link javascriptBOMWindowMethod Yellow
highlight! link javascriptHeadersMethod Yellow
highlight! link javascriptRequestMethod Yellow
highlight! link javascriptResponseMethod Yellow
highlight! link javascriptES6SetMethod Yellow
highlight! link javascriptReflectMethod Yellow
highlight! link javascriptPaymentMethod Yellow
highlight! link javascriptPaymentResponseMethod Yellow
highlight! link javascriptTypedArrayStaticMethod Yellow
highlight! link javascriptGeolocationMethod Yellow
highlight! link javascriptES6MapMethod Yellow
highlight! link javascriptServiceWorkerMethod Yellow
highlight! link javascriptCacheMethod Yellow
highlight! link javascriptFunctionMethod Yellow
highlight! link javascriptXHRMethod Yellow
highlight! link javascriptBOMNavigatorMethod Yellow
highlight! link javascriptServiceWorkerMethod Yellow
highlight! link javascriptDOMEventTargetMethod Yellow
highlight! link javascriptDOMEventMethod Yellow
highlight! link javascriptIntlMethod Yellow
highlight! link javascriptDOMDocMethod Yellow
highlight! link javascriptStringStaticMethod Yellow
highlight! link javascriptStringMethod Yellow
highlight! link javascriptSymbolStaticMethod Yellow
highlight! link javascriptRegExpMethod Yellow
highlight! link javascriptObjectStaticMethod Yellow
highlight! link javascriptObjectMethod Yellow
highlight! link javascriptBOMLocationMethod Yellow
highlight! link javascriptJSONStaticMethod Yellow
highlight! link javascriptGeneratorMethod Yellow
highlight! link javascriptEncodingMethod Yellow
highlight! link javascriptPromiseStaticMethod Yellow
highlight! link javascriptPromiseMethod Yellow
highlight! link javascriptBOMHistoryMethod Yellow
highlight! link javascriptDOMFormMethod Yellow
highlight! link javascriptClipboardMethod Yellow
highlight! link javascriptTypedArrayStaticMethod Yellow
highlight! link javascriptBroadcastMethod Yellow
highlight! link javascriptDateStaticMethod Yellow
highlight! link javascriptDateMethod Yellow
highlight! link javascriptConsoleMethod Yellow
highlight! link javascriptArrayStaticMethod Yellow
highlight! link javascriptArrayMethod Yellow
highlight! link javascriptMathStaticMethod Yellow
highlight! link javascriptSubtleCryptoMethod Yellow
highlight! link javascriptCryptoMethod Yellow
...
highlight! link javascriptBOMNavigatorProp Yellow
...
call s:HL('TSKeywordFunction', s:palette.red, s:palette.none)
...
call s:HL('javaTSMethod', s:palette.purple, s:palette.none)
...
call s:HL('TSKeyword', s:palette.bg_red, s:palette.none)
